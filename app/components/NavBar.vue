<template>
    <nav class="flex justify-between items-center px-10 py-6 border-b bg-white" role="navigation" aria-label="main navigation">
        ...
        <div class="hidden md:flex items-center gap-6 text-sm">
            <a class="hover:text-gray-900 text-gray-600 transition" href="/"></a>
            <a class="hover:text-gray-900 text-gray-600 transition" href="/elecciones">Elecciones</a>
            <a class="hover:text-gray-900 text-gray-600 transition" href="/nodos">Nodos</a>
        </div>
    </nav>
</template>
